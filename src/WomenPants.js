...
function WomenPants() {
    ...
    const WomenPantsCollection = collection(db, 'Womens', 'Women Pants', 'Women Pants Collection');
    ...
    const fetchData = async () => {
      try {
          ...
          setWPList(data); // Assuming you want to set the data in the movieList state
